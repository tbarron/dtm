...
@pytest.mark.parametrize("left, right, exp", [
    ...
    dtu.pp(dt("2001.0102 10:00:00"), td(365), dt("2001.0102 10:06:05"),
           id="dt+03: <dt> + <td> => <dt>"),
    dtu.pp(dt("2001.0102 10:00:00"), td(-365), dt("2001.0102 09:53:55"),
           id="dt+04: <dt> + (-<td>) => <dt>"),
    ...
    dtu.pp(365, dt("2001.0102 10:00:00"), dt("2001.0102 10:06:05"),
           id="dt+07: <int> + <dt> => <dt>"),
    dtu.pp(-909, dt("2001.0102 10:00:00"), dt("2001.0102 09:44:51"),
           id="dt+08: (-<int>) + <dt> => <dt>"),
...
@pytest.mark.parametrize("left, right, exp", [
    ...
    dtu.pp(dt("2005.0101 10:07:00"), td(-420), dt("2005.0101 10:14:00"),
           id="dt-10: <dt> - <td> => <dt>"),
    dtu.pp(dt("2005.0101 10:07:00"), timedelta(0, 600),
           dt("2005.0101 09:57:00"), id="dt-11: <dt> - <timedelta> => <dt>"),
    dtu.pp(dt("2005.0101 10:07:00"), timedelta(0, -600),
           dt("2005.0101 10:17:00"), id="dt-12: <dt> - <timedelta> => <dt>"),
...
# -----------------------------------------------------------------------------
@pytest.mark.parametrize("left, right, exp", [
    dtu.pp(dt(), datetime.now(), True, id=ppf("dt == datetime", "T")),
    dtu.pp(datetime.now(), dt(), True, id=ppf("datetime == dt", "T")),
    dtu.pp(dt(epoch=1571315783), datetime.fromtimestamp(1571315783), True,
           id=ppf("dt(epoch) == datetime.epoch()", "T")),
    dtu.pp(datetime.fromtimestamp(1571315783), dt(epoch=1571315783), True,
           id=ppf("datetime.epoch() == dt(epoch)", "T")),
    dtu.pp(dt(epoch=1571315783), datetime.fromtimestamp(1571315784), False,
           id=ppf("dt(epoch) == datetime.epoch()", "F")),
    dtu.pp(datetime.fromtimestamp(1571315784), dt(epoch=1571315783), False,
           id=ppf("datetime.epoch() == dt(epoch)", "F")),
    dtu.pp(dt(2018, 1, 17), dt("2018.0117"), True,
           id=ppf("dt(ints) == dt(str)", "T")),
    dtu.pp(dt(2018, 1, 17, 6, 30), dt("2018.0117"), False,
           id=ppf("dt(ints) == dt(str)", "F")),
    dtu.pp(dt(2018, 1, 17), 17, dtu.unsupp_cmp('dt', "class 'int'"),
           id=ppf("dt == number", "X")),
    dtu.pp(17, dt(2018, 1, 17), dtu.unsupp_cmp('dt', "class 'int'"),
           id=ppf("number == dt", "X")),
    dtu.pp(dt(2018, 1, 17), 'a str', dtu.unsupp_cmp('dt', "class 'str'"),
           id=ppf("dt == str", "X")),
    dtu.pp('this is a string', dt(2018, 1, 17),
           dtu.unsupp_cmp('dt', "class 'str'"), id=ppf("str == dt", "X")),
    dtu.pp(dt(2018, 1, 17), [15, 17, 25],
           dtu.unsupp_cmp('dt', "class 'list'"), id=ppf("dt == list", "X")),
    dtu.pp([15, 17, 25], dt(2018, 1, 17),
           dtu.unsupp_cmp('dt', "class 'list'"), id=ppf("list == dt", "X")),
    dtu.pp(dt(2018, 1, 17), td(93),
           dtu.unsupp_cmp('dt', "class 'dtm.td'"), id=ppf("dt == td", "X")),
])
...
# -----------------------------------------------------------------------------
@pytest.mark.parametrize("left, right, exp", [
    dtu.pp(dt(), datetime.now(), False, id=ppf("dt != datetime", "F")),
    dtu.pp(datetime.now(), dt(), False, id=ppf("datetime != dt", "F")),
    dtu.pp(dt(epoch=1571315783), datetime.fromtimestamp(1571315784), True,
           id=ppf("dt != datetime", "T")),
    dtu.pp(datetime.fromtimestamp(1571315784), dt(epoch=1571315783), True,
           id=ppf("datetime != dt", "T")),
    ...
    dtu.pp(dt(2018, 1, 17), 'this is a str',
           dtu.unsupp_cmp('dt', "class 'str'"), id=ppf("dt != str", "X")),
...
@pytest.mark.parametrize("inp, bench, exp", [
    dtu.pp(dt("2012.0101"), dt("2012.0102"), False,
           id=ppf("2012.0101 >= 2012.0102", "F")),
    dtu.pp(dt("2011.1231"), dt("2012.0101"), False,
           id=ppf("2011.1231 >= 2012.0101", "F")),
    dtu.pp(dt("2012.0102"), dt("2012.0101"), True,
           id=ppf("2012.0102 >= 2012.0101", "T")),
    dtu.pp(dt("2012.0102"), dt("2011.1231"), True,
           id=ppf("2012.0102 >= 2011.1231", "T")),
    dtu.pp(dt("2012.0102"), dt("2012.0102"), True,
           id=ppf("2012.0102 >= 2012.0102", "T")),

    dtu.pp(dt("2012.0101"), datetime(2012, 1, 2), False,
           id=ppf("2012.0101 >= datetime(2012, 1, 2)", "F")),
    dtu.pp(dt("2011.1231"), datetime(2012, 1, 1), False,
           id=ppf("2011.1231 >= datetime(2012, 1, 1)", "F")),
    dtu.pp(dt("2012.0102"), datetime(2012, 1, 1), True,
           id=ppf("2012.0101 >= datetime(2012, 1, 1)", "T")),
    dtu.pp(dt("2012.0102"), datetime(2011, 9, 3), True,
           id=ppf("2012.0102 >= datetime(2011, 9, 3)", "T")),
    dtu.pp(dt("2012.0102"), datetime(2012, 1, 2), True,
           id=ppf("2012.0102 >= datetime(2012, 1, 2)", "T")),

    dtu.pp(datetime(2012, 1, 2), dt("2012.0103"), False,
           id=ppf("datetime(2012, 1, 2) >= 2012.0103", "F")),
    dtu.pp(datetime(2011, 9, 3), dt("2012.0101"), False,
           id=ppf("datetime(2011, 9, 3) >= 2012.0101", "F")),
    dtu.pp(datetime(2012, 1, 3), dt("2012.0102"), True,
           id=ppf("datetime(2012, 1, 3) >= 2012.0102", "F")),
    dtu.pp(datetime(2011, 9, 3), dt("2011.0102"), True,
           id=ppf("datetime(2011, 9, 3) >= 2011.0102", "F")),
    dtu.pp(datetime(2012, 1, 2), dt("2012.0102"), True,
           id=ppf("datetime(2012, 1, 2) >= 2012.0102", "F")),

    dtu.pp(dt("2012.0101"), 17, dtu.unsupp_cmp('dt', "class 'int'"),
           id=ppf("dt >= 17", "X")),
    dtu.pp(17, dt("2012.0101"), dtu.unsupp_cmp('dt', "class 'int'"),
           id=ppf("17 >= dt", "X")),
    dtu.pp(dt("2012.0101"), "a string",
           dtu.unsupp_cmp('dt', "class 'str'"), id=ppf("dt >= str", "X")),
    dtu.pp("a string", dt("2012.0101"),
           dtu.unsupp_cmp('dt', "class 'str'"), id=ppf("str >= dt", "X")),
...
@pytest.mark.parametrize("inp, bench, exp", [
    ...
    dtu.pp(dt("2012.0102"), dt("2011.1231"), True,
           id=ppf("2012.0102 > 2011.1231", "T")),
    dtu.pp(dt("2012.0102"), dt("2012.0102"), False,
           id=ppf("2012.0102 > 2012.0102", "F")),
    ...
    dtu.pp(dt("2011.1231"), datetime(2012, 1, 1), False,
           id=ppf("2011.1231 > datetime(2012, 1, 1)", "F")),
    dtu.pp(dt("2012.0102"), datetime(2012, 1, 1), True,
           id=ppf("2012.0102 > datetime(2012, 1, 1)", "T")),
    dtu.pp(dt("2012.0102"), datetime(2011, 9, 3), True,
           id=ppf("2012.0102 > datetime(2011, 9, 3)", "T")),
    dtu.pp(dt("2012.0102"), datetime(2012, 1, 2), False,
           id=ppf("2012.0102 > datetime(2012, 1, 2)", "F")),

    dtu.pp(datetime(2012, 1, 1), dt("2012.0102"), False,
           id=ppf("datetime(2012, 1, 1) > 2012.0102", "F")),
    dtu.pp(datetime(2011, 9, 3), dt("2012.0101"), False,
           id=ppf("datetime(2011, 9, 3) > 2012.0101", "F")),
    dtu.pp(datetime(2012, 1, 2), dt("2012.0101"), True,
           id=ppf("datetime(2012, 1, 2) > 2012.0101", "T")),
    dtu.pp(datetime(2012, 1, 2), dt("2011.1231"), True,
           id=ppf("datetime(2012, 1, 2) > 2011.1231", "T")),
    dtu.pp(datetime(2012, 1, 2), dt("2012.0102"), False,
           id=ppf("datetime(2012, 1, 2) > 2012.0102", "F")),

    dtu.pp(dt("2012.0101"), 17, dtu.unsupp_cmp('dt', "class 'int'"),
           id=ppf("dt(2012.0101) > 17", "X")),
    dtu.pp(17, dt("2012.0101"), dtu.unsupp_cmp('dt', "class 'int'"),
           id=ppf("17 > dt(2012.0101)", "X")),
    dtu.pp(dt("2012.0101"), "a string", dtu.unsupp_cmp('dt', "class 'str'"),
           id=ppf("dt(2012.0101) > 'a string'", "X")),
    dtu.pp("a string", dt("2012.0101"), dtu.unsupp_cmp('dt', "class 'str'"),
           id=ppf("'a string' > dt(2012.0101)", "X")),
    dtu.pp(dt("2012.0101"), [1, 2, 3], dtu.unsupp_cmp('dt', "class 'list'"),
           id=ppf("dt(2012.0101) > [1, 2, 3]", "X")),
    dtu.pp([1, 2, 3], dt("2012.0101"), dtu.unsupp_cmp('dt', "class 'list'"),
           id=ppf("[1, 2, 3] > dt(2012.0101)", "X")),
    dtu.pp(dt("2012.0101"), td(17), dtu.unsupp_cmp('dt', "class 'dtm.td'"),
           id=ppf("dt(2012.0101) > td(17)", "X")),
])
...
# -----------------------------------------------------------------------------
@pytest.mark.parametrize("inp, bench, exp", [
    dtu.pp(dt("2012.0101"), dt("2012.0102"), True,
           id=ppf("2012.0101 <= 2012.0102", "T")),
    dtu.pp(dt("2011.1231"), dt("2012.0101"), True,
           id=ppf("2011.1231 <= 2012.0101", "T")),
    dtu.pp(dt("2012.0102"), dt("2012.0101"), False,
           id=ppf("2012.0102 <= 2012.0101", "F")),
    dtu.pp(dt("2012.0102"), dt("2011.1231"), False,
           id=ppf("2012.0102 <= 2011.1231", "F")),
    dtu.pp(dt("2012.0102"), dt("2012.0102"), True,
           id=ppf("2012.0102 <= 2012.0102", "T")),

    dtu.pp(dt("2012.0101"), datetime(2012, 1, 2), True,
           id=ppf("2012.0101 <= datetime(2012, 1, 2)", "T")),
    dtu.pp(dt("2011.1231"), datetime(2012, 1, 1), True,
           id=ppf("2011.1231 <= datetime(2012, 1, 1)", "T")),
    dtu.pp(dt("2012.0102"), datetime(2012, 1, 1), False,
           id=ppf("2012.0102 <= datetime(2012, 1, 1)", "F")),
    dtu.pp(dt("2012.0102"), datetime(2011, 9, 3), False,
           id=ppf("2012.0102 <= datetime(2011, 9, 3)", "F")),
    dtu.pp(dt("2012.0102"), datetime(2012, 1, 2), True,
           id=ppf("2012.0102 <= datetime(2012, 1, 2)", "T")),

    dtu.pp(datetime(2012, 1, 1), dt("2012.0102"), True,
           id=ppf("datetime(2012, 1, 1) <= 2012.0102", "T")),
    dtu.pp(datetime(2011, 9, 3), dt("2012.0101"), True,
           id=ppf("datetime(2011, 9, 3) <= 2012.0101", "T")),
    dtu.pp(datetime(2012, 1, 2), dt("2012.0101"), False,
           id=ppf("datetime(2012, 1, 2) <= 2012.0101", "F")),
    dtu.pp(datetime(2012, 1, 2), dt("2011.1231"), False,
           id=ppf("datetime(2012, 1, 2) <= 2011.1231", "F")),
    dtu.pp(datetime(2012, 1, 2), dt("2012.0102"), True,
           id=ppf("datetime(2012, 1, 2) <= 2012.0102", "T")),
...
@pytest.mark.parametrize("inp, bench, exp", [
    ...
    dtu.pp(datetime(2012, 1, 2), dt("2012.0105"), True,
           id=ppf("datetime(2012, 1, 2) < 2012.0105", "T")),
    dtu.pp(datetime(2012, 1, 1), dt("2012.1231"), True,
           id=ppf("datetime(2012, 1, 1) < 2012.1231", "T")),
    dtu.pp(datetime(2012, 1, 7), dt("2012.0102"), False,
           id=ppf("datetime(2012, 1, 7) < 2012.0102", "F")),
    dtu.pp(datetime(2012, 9, 3), dt("2012.0102"), False,
           id=ppf("datetime(2012, 9, 3) < 2012.0102", "F")),
    dtu.pp(datetime(2012, 1, 2), dt("2012.0102"), False,
           id=ppf("datetime(2012, 1, 2) < 2012.0102", "F")),
...
@pytest.mark.parametrize("when, fmt, tzone, exp", [
    pp('2016-09-28T16:46:42Z', "%Y-%m-%dT%H:%M:%SZ", None,
       dt(2016, 9, 28, 16, 46, 42), id=ppf("iso default tz", w=46)),
    pp('2020.0229', "%Y.%m%d", None, dt("2020.0229"),
       id=ppf("ymd default tz", w=46)),
    pp('2013.0310 00:00:00', "%Y.%m%d %H:%M:%S", 'utc',
       dt("2013.0310 00:00:00", tz='utc'), id=ppf("utc explicit", w=46)),

    pp('2013.0310 02:00:00', "%Y.%m%d %H:%M:%S", 'est5edt',
       dt("2013.0310 07:00:00", tz='utc'), id=ppf("est 2am -> utc 7am", w=46)),
    pp('2013.0310 03:00:00', "%Y.%m%d %H:%M:%S", 'est5edt',
       dt("2013.0310 07:00:00", tz='utc'), id=ppf("est 3am -> utc 7am", w=46)),

    pp('2013.0310 02:59:59', "%Y.%m%d %H:%M:%S", 'est5edt',
       dt("2013.0310 07:59:59", tz='utc'),
       id=ppf("est 2:59:59 -> utc 7:59:59", w=46)),
    pp('2013.0310 03:59:59', "%Y.%m%d %H:%M:%S", 'est5edt',
       dt("2013.0310 07:59:59", tz='utc'),
       id=ppf("est 3:59:59 -> utc 7:59:59", w=46)),

    pp('2013.0310 07:00:00', "%Y.%m%d %H:%M:%S", 'utc',
       dt("2013.0310 02:00:00", tz='est5edt'),
       id=ppf("utc 7am -> est 2am", w=46)),
    pp('2013.0310 07:00:00', "%Y.%m%d %H:%M:%S", 'utc',
       dt("2013.0310 03:00:00", tz='est5edt'),
       id=ppf("utc 7am -> est 3am", w=46)),

    pp('2013.0310 08:00:00', "%Y.%m%d %H:%M:%S", 'utc',
       dt("2013.0310 04:00:00", tz='est5edt'),
       id=ppf("utc 8 -> est 4am", w=46)),
])
...
# -----------------------------------------------------------------------------
@pytest.mark.parametrize("obj, otz, exp", [
    pp(dt("2012.0704"), None, "wed",
       id=ppf("wed -> wed", "T", w=47)),
    pp(dt("2012.0704"), 'Pacific/Midway', "tue",
       id=ppf("wed -> tue", "T", w=47)),
    pp(dt("2012.0704 16:00:00", tz='Pacific/Midway'),
       'Pacific/Auckland', 'thu',
       id=ppf("midway -> auckland", "T", w=47)),
    pp(dt("2012.0704"), 'no_such_tz',
       pytz.exceptions.UnknownTimeZoneError("no_such_tz"),
       id=ppf("bad timezone", "X", w=47)),
])
...
@pytest.mark.parametrize("when, wkday, exp", [
    pp(dt(2005, 5, 1), 17, dt_error("argument must be a str or list"),
       id=ppf("bad argument", "X", w=39)),

    pp(dt(2000, 12, 4), 'mon', dt(2000, 12, 4),
       id=ppf("weekday_ceiling mon", "T", w=39)),
    pp(dt(2000, 12, 4), 'sun', dt(2000, 12, 10),
       id=ppf("weekday_ceiling sun", "T", w=39)),
    pp(dt(2000, 12, 4), 'sat', dt(2000, 12, 9),
       id=ppf("weekday_ceiling sat", "T", w=39)),
    pp(dt(2000, 12, 4), 'fri', dt(2000, 12, 8),
       id=ppf("weekday_ceiling fri", "T", w=39)),
    pp(dt(2000, 12, 4), 'thu', dt(2000, 12, 7),
       id=ppf("weekday_ceiling thu", "T", w=39)),
    pp(dt(2000, 12, 4), 'wed', dt(2000, 12, 6),
       id=ppf("weekday_ceiling wed", "T", w=39)),
    pp(dt(2000, 12, 4), 'tue', dt(2000, 12, 5),
       id=ppf("weekday_ceiling tue", "T", w=39)),

    pp(dt(2003, 7, 4), ['sat', 'wed'], dt(2003, 7, 5),
       id=ppf("fri.ceil(sat, wed)", "T", w=39)),
    pp(dt(2003, 7, 5), ['sat', 'wed'], dt(2003, 7, 5),
       id=ppf("sat.ceil(sat, wed)", "T", w=39)),
    pp(dt(2003, 7, 6), ['sat', 'wed'], dt(2003, 7, 9),
       id=ppf("sun.ceil(sat, wed)", "T", w=39)),
    pp(dt(2003, 7, 7), ['sat', 'wed'], dt(2003, 7, 9),
       id=ppf("mon.ceil(sat, wed)", "T", w=39)),
    pp(dt(2003, 7, 8), ['sat', 'wed'], dt(2003, 7, 9),
       id=ppf("tue.ceil(sat, wed)", "T", w=39)),
    pp(dt(2003, 7, 9), ['sat', 'wed'], dt(2003, 7, 9),
       id=ppf("wed.ceil(sat, wed)", "T", w=39)),
    pp(dt(2003, 7, 10), ['sat', 'wed'], dt(2003, 7, 12),
       id=ppf("thu.ceil(sat, wed)", "T", w=39)),
])
...
@pytest.mark.parametrize("when, wkday, exp", [
    pp(dt(2005, 5, 1), 17, dt_error("argument must be a str or list"),
       id=ppf("bad argument", "X", w=41)),

    pp(dt(2000, 12, 1), 'sat', dt(2000, 11, 25),
       id=ppf("weekday_floor sat", "T", w=41)),
    pp(dt(2000, 12, 1), 'sun', dt(2000, 11, 26),
       id=ppf("weekday_floor sun", "T", w=41)),
    pp(dt(2000, 12, 1), 'mon', dt(2000, 11, 27),
       id=ppf("weekday_floor mon", "T", w=41)),
    pp(dt(2000, 12, 1), 'tue', dt(2000, 11, 28),
       id=ppf("weekday_floor tue", "T", w=41)),
    pp(dt(2000, 12, 1), 'wed', dt(2000, 11, 29),
       id=ppf("weekday_floor wed", "T", w=41)),
    pp(dt(2000, 12, 1), 'thu', dt(2000, 11, 30),
       id=ppf("weekday_floor thu", "T", w=41)),
    pp(dt(2000, 12, 1), 'fri', dt(2000, 12, 1),
       id=ppf("weekday_floor fri", "T", w=41)),

    pp(dt(2003, 7, 4), ['sat', 'wed'], dt(2003, 7, 2),
       id=ppf("fri.floor(sat, wed)", "T", w=41)),
    pp(dt(2003, 7, 5), ['sat', 'wed'], dt(2003, 7, 5),
       id=ppf("sat.floor(sat, wed)", "T", w=41)),
    pp(dt(2003, 7, 6), ['sat', 'wed'], dt(2003, 7, 5),
       id=ppf("sun.floor(sat, wed)", "T", w=41)),
    pp(dt(2003, 7, 7), ['sat', 'wed'], dt(2003, 7, 5),
       id=ppf("mon.floor(sat, wed)", "T", w=41)),
    pp(dt(2003, 7, 8), ['sat', 'wed'], dt(2003, 7, 5),
       id=ppf("tue.floor(sat, wed)", "T", w=41)),
    pp(dt(2003, 7, 9), ['sat', 'wed'], dt(2003, 7, 9),
       id=ppf("wed.floor(sat, wed)", "T", w=41)),
    pp(dt(2003, 7, 10), ['sat', 'wed'], dt(2003, 7, 9),
       id=ppf("thu.floor(sat, wed)", "T", w=41)),
])
...
@pytest.mark.parametrize("when", [
    pp("2001.0719", id=ppf("2001.0719", "T", w=51)),
    pp("2007.0917", id=ppf("2007.0917", "T", w=51)),
    pp("2005.0313", id=ppf("2005.0313", "T", w=51)),
])
def test_ymd(when):
    """
    Test dt().ymd().
...
@pytest.mark.parametrize("when, exp", [
    pp("2001.0719", "2001.0719.thu", id=ppf("thu", "T", w=50)),
    pp("2007.0917", "2007.0917.mon", id=ppf("mon", "T", w=50)),
    pp("2005.0313", "2005.0313.sun", id=ppf("sun", "T", w=50)),
])
